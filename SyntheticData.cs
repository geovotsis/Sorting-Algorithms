...
namespace Assignment4
{
    class SyntheticData
    {
        ...
        public SyntheticData()
        {
            ...
            Shirt s17 = new Shirt(Color.RED, Size.XXL, Fabric.LINEN);
            ...
            Shirt s21 = new Shirt(Color.GREEN, Size.XL, Fabric.CASHMERE);
            ...
            Shirt s42 = new Shirt(Color.BLUE, Size.XL, Fabric.COTTON);
            Shirt s43 = new Shirt(Color.RED, Size.S, Fabric.LINEN);
            Shirt s44 = new Shirt(Color.ORANGE, Size.M, Fabric.SILK);
            Shirt s45 = new Shirt(Color.GREEN, Size.XXL, Fabric.WOOL);
